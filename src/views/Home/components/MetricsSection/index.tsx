  ...
  return (
    <Flex justifyContent="center" alignItems="center" flexDirection="column">
      ...
      {/* <Heading textAlign="center" scale="md" mb="32px">
        {t('Rewarding Binance Smart Chain Yield Farmers, with SLOKI, every day!')}
      </Heading> */}
      {/* <Flex flexWrap="wrap">
        ...
        <StyledCard>
          ...
          <Flex color="#000" mb="24px">
            <Button style={{background: "#113356", borderRadius: "24px"}}>
              <Link href="http://localhost:3000/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82" style={{textDecoration: "none"}}>
              Buy SLOKI
              </Link>            
            </Button>
          ...
          <Flex color="#000" mb="24px" justifyContent="space-between">
            {!account?
              <Text color="#000" fontSize="18px">LOCKED</Text>
              : <><Text color="#000" fontSize="18px">SLOKI</Text>
              {fetchStatus !== FetchStatus.SUCCESS ? (
                <Skeleton height="22px" width="60px" />
              ) : (
                <Text color="#000" fontSize="18px">{formatBigNumber(balance, 9,9)}</Text>
              )}
              </>
            }  
          </Flex>
